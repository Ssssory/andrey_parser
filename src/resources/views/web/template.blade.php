...
<head>
    ...
    <!-- BoxIcon  CSS -->
    <link href="web/css/boxicons.min.css" rel="stylesheet">
    <!-- Select2  CSS -->
    <link href="web/css/nice-select.css" rel="stylesheet">
    <!--  Style CSS  -->
    <link rel="stylesheet" href="web/css/style.css">
    <!-- Title -->
    <title>Drivco - Car Dealer HTML Template</title>
    <link rel="icon" href="web/img/sm-logo.svg" type="image/gif" sizes="20x20">
</head>
...
<body class="tt-magic-cursor home-5">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <ul class="social-icon">
                            <li><a href="#"><img src="web/img/home1/icon/google.svg" alt=""></a></li>
                            <li><a href="#"><img src="web/img/home1/icon/facebook.svg" alt=""></a></li>
                            <li><a href="#"><img src="web/img/home1/icon/twiter.svg" alt=""></a></li>
                        </ul>
                    </form>
                </div>
            </div>
    ...
    <header class="header-area style-5">
        <div class="header-logo d-lg-none d-flex">
            <a href="index.html"><img alt="image" class="img-fluid" src="web/img/green-logo.svg"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="index.html"><img alt="image" src="web/img/green-logo.svg"></a>
                </div>
            </div>
            <ul class="menu-list">
                    ...
                    <div class="mega-menu">
                        <ul class="menu-row">
                            <li class="menu-single-item">
                                ...
                                <ul>
                                    <li><a href="single-brand-category.html">Merchedes Benz (10) <img src="web/img/menu-icon/merchedes.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Volkswagen (10) <img src="web/img/menu-icon/volkswagen.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Ferrari (10) <img src="web/img/menu-icon/ferrari.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Mazda (10) <img src="web/img/menu-icon/mazda.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Mitsubishi (10) <img src="web/img/menu-icon/mitsubishi.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Lamborghini (10) <img src="web/img/menu-icon/lamborghini.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Tesla (10) <img src="web/img/menu-icon/tesla.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Toyota (10) <img src="web/img/menu-icon/toyota.svg" alt=""></a></li>
                            ...
                            <li class="menu-single-item">
                                ...
                                <ul>
                                    <li><a href="single-brand-category.html">Panama City (10)<img src="web/img/menu-icon/panama.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Sydne City (10)<img src="web/img/menu-icon/sydne.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Melbourne City (10)<img src="web/img/menu-icon/melbourne.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">New Delhi (10)<img src="web/img/menu-icon/delhi.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">New York (10)<img src="web/img/menu-icon/newYork.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">Menchester City (10)<img src="web/img/menu-icon/menchester.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">City of Greece (10)<img src="web/img/menu-icon/greece.svg" alt=""></a></li>
                                    <li><a href="single-brand-category.html">City of Abu-dabi (10)<img src="web/img/menu-icon/abudabi.svg" alt=""></a></li>
                                    <li class="explore-more-btn">
                                        <a href="brand-category.html">Explore More <i class="bi bi-arrow-right"></i></a>
                                    </li>
                                </ul>
    ...
    <script src="web/js/simpleParallax.min.js"></script>
